...
@Component({
  selector: 'app-var-wall',
  templateUrl: './var-wall.component.html',
  styleUrls: ['./var-wall.component.css']
})
export class VarWallComponent implements OnInit {
  ...
  // This distortion factor is used in effect calculation, can be adjusted
  @Input("distort-factor")
  distort_factor = 1.5;

  // Currently focused row and column, -1 for unfocused
  ...
  distortNodes() {
    ...
    // Apply effect to 5 cells
    const extent_x = 0.5 * 5 * this.cell_width_;
    const extent_y = 0.5 * 5 * this.cell_height_;
